...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear, PatchTST, CATS, FITS, iTransformer, TimesNet, TiDE, FormerBaseline, Autoregressive, AutoregressiveAlignment
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            ...
            'AutoregressiveAlignment': AutoregressiveAlignment
        }
