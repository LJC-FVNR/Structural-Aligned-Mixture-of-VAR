...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.tokenizer = MultiSegmentTokenizer(s=self.pred_len, n_channels=self.enc_in, d_model=self.d_input, number_of_targets=self.number_of_targets, univariate=False)
